...
function Referrals() {
  ...
  return (
    <section className="grid h-full w-full place-items-center">
      <div className="flex w-full max-w-[800px] flex-col gap-20">
        ...
        <div className="flex flex-col items-center justify-between gap-8 sm:flex-row sm:items-start sm:gap-0">
          ...
          <div className="flex w-full max-w-[230px] flex-col items-center gap-2">
            ...
            <span className="text-center font-dm_sans text-siteHeadingDark/70">
              They register using your referral link. the process will only take
              a few minutes.
            </span>
          </div>
          <div className="flex w-full max-w-[230px] flex-col items-center gap-2">
            ...
            <span className="text-center font-dm_sans text-siteHeadingDark/70">
              Thats it! you both get rewarded with $50 each, and you can enjoy
              our service.
            </span>
          </div>
        </div>
        <div className="flex flex-col items-center text-siteHeadingDark">
          ...
          <span className="font-dm_sans text-[20px] font-bold text-stone-500/40 md:text-[80px]">
            {referralCode}
          </span>
          <span className="font-dm_sans text-lg font-bold">
